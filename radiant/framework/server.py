...
#     """
#     Tornado handler that dynamically renders a CSS stylesheet from an XML-based theme definition.
#
#     The resulting CSS is rendered using Jinja2 with values extracted from the theme file.
#     """
#
#     def get(self):
#         """
#         Handle GET requests by rendering a CSS template using theme variables.
#
#         The theme file is expected to be defined in the server's settings and should be an XML file.
#         If it does not exist, a default theme is used.
#         """
#         # Load theme values from XML
#         theme = self.get_theme()
#
#         # Initialize Jinja2 environment and loader for templates
#         loader = jinja2.FileSystemLoader(
#             os.path.join(os.path.dirname(__file__), "templates")
#         )
#         env = jinja2.Environment(autoescape=True, loader=loader)
#
#         # Add custom filter to convert hex color to RGB vector
#         env.filters["vector"] = self.hex2vector
#
#         # Load and render CSS template using theme values
...
#         """
#         Convert a hexadecimal color string to a comma-separated RGB vector.
#
#         Parameters
#         ----------
#         hex_ : str
#             A hexadecimal string like "#FF8800".
#
#         Returns
#         -------
#         str
#             A string like "255, 136, 0"
#         """
#         return ", ".join([str(int(hex_[i : i + 2], 16)) for i in range(1, 6, 2)])
#
#     def get_theme(self):
#         """
#         Load theme variables from the XML file defined in the settings.
#
#         Returns
#         -------
#         dict
#             A dictionary of CSS variables extracted from the XML.
#         """
#         theme = self.settings["theme"]
#
#         # Fallback to default theme if none provided or file is missing
#         if (not theme) or (not os.path.exists(theme)):
#             theme = os.path.join(
#                 os.path.dirname(__file__), "templates", "default_theme.xml"
#             )
#
#         # Parse XML and extract theme variables
