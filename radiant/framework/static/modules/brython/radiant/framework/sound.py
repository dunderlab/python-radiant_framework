...
class Tone:
    ...
    def __init__(self, gain=0.5):
        ...
        self.oscilator = self.context.createOscillator()
        self.oscilator.type = "sine"
        self.gain = self.context.createGain()
        self.oscilator.connect(self.gain)
        self.oscilator.start(0)
        self.set_gain(gain)

    # ----------------------------------------------------------------------
    def start(self, note, gain=0.5):
        """"""
        self.set_note(note)
        ...
        # self.oscilator.connect(self.context.destination)
    ...
    def set_gain(self, gain):
        """"""
        self.gain.gain.setValueAtTime(gain, self.context.currentTime)

    # ----------------------------------------------------------------------
    def set_note(self, note):
        """"""
        if note in self.note_values:
    ...
    def stop(self):
        """"""
        # self.oscilator.disconnect(self.context.destination)
        self.gain.disconnect(self.context.destination)

    # ----------------------------------------------------------------------
    def __call__(self, note, duration=200, gain=0.5):
        """"""
        self.start(note, gain)
