...
class Slider extends s$2 {
    ...
    render() {
      ...
      >
        ${n$1(this.allowRange, () => this.renderInput(inputAProps))}
        ${this.renderInput(inputBProps)}
        ${this.renderTrack()}
        <div class="handleContainerPadded">
          <div class="handleContainerBlock">
            <div class="handleContainer ${o(handleContainerClasses)}">
              ${n$1(this.allowRange, () => this.renderHandle(handleAProps))}
    ...
    renderTrack() {
        ...
        return y `<div class="track ${o(trackClasses)}"></div>`;
    }
    renderLabel(value) {
    ...
    renderHandle({ id, lesser, showRipple, hover, label }) {
        ...
        ${n$1(this.withLabel, () => this.renderLabel(label))}
      ${n$1(showRipple, () => this.renderRipple(id))}
...
MdSlider.styles = [styles$Y, styles$10];
MdSlider = __decorate([
    e$a('md-slider')
], MdSlider);
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$W = i$4 `.md3-navigation-drawer-modal{background-color:var(--_container-color);border-radius:var(--_container-shape);height:var(--_container-height)}.md3-navigation-drawer-modal.md3-navigation-drawer-modal--opened{inline-size:var(--_container-width)}.md3-navigation-drawer-modal .md3-navigation-drawer-modal__slot-content{min-inline-size:var(--_container-width);max-inline-size:var(--_container-width)}/*# sourceMappingURL=shared-styles.css.map */
`;
...
MdNavigationDrawer.styles = [styles$W, styles$X];
...
MdNavigationDrawerModal.styles = [styles$W, styles$V];
...
class Badge extends s$2 {
    ...
    render() {
        ...
        return y `<div class="md3-badge ${o(classes)}">
...
class NavigationTab extends s$2 {
    constructor() {
        ...
        this.renderRipple = () => {
            return y `<md-ripple ?disabled="${this.disabled}" class="md3-navigation-tab__ripple"></md-ripple>`;
        };
    }
    render() {
        // Needed for closure conformance
...
MdNavigationTab.styles = [styles$T];
...
MdOutlinedField.styles = [styles$R, styles$S];
...
MdFilledField.styles = [styles$R, styles$Q];
...
class CircularProgress extends s$2 {
    ...
    render() {
        ...
        return y `
      <div
        class="circular-progress ${o(classes)}"
        role="progressbar"
        aria-label="${ariaLabel || b}"
        aria-valuemin="0"
        aria-valuemax="1"
    ...
    renderDeterminateContainer() {
        ...
        return y `<svg viewBox="0 0 4800 4800">
...
MdCircularProgress.styles = [styles$P];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$O = i$4 `:host{--_color: var(--md-icon-color, inherit);--_font: var(--md-icon-font, "Material Symbols Outlined");--_font-variation-settings: var(--md-icon-font-variation-settings, inherit);--_size: var(--md-icon-size, 24px);--_weight: var(--md-icon-weight, 400);display:inline-flex;color:var(--_color);font-family:var(--_font);font-weight:var(--_weight);font-style:normal;font-size:var(--_size);font-variation-settings:var(--_font-variation-settings);line-height:1;overflow:hidden;letter-spacing:normal;text-transform:none;white-space:nowrap;word-wrap:normal;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility;-moz-osx-font-smoothing:grayscale}span ::slotted(svg){fill:currentColor}span ::slotted(*){height:var(--_size);width:var(--_size)}/*# sourceMappingURL=icon-styles.css.map */
`;
...
MdNavigationBar.styles = [styles$N];
...
MdOutlinedSegmentedButton.styles = [styles$L, styles$M];
...
class ListItemEl extends s$2 {
     ...
     */
    renderFocusRing() {
        return y `<md-focus-ring class="focus-ring" for="item"></md-focus-ring>`;
    }
    /**
...
MdMenuItemLink.styles = [styles$J, styles$H, styles$K, styles$I];
...
MdMenuItem.styles = [styles$J, styles$H, styles$K, styles$I];
...
class Menu extends s$2 {
     ...
     */
    renderElevation() {
        return y `<md-elevation></md-elevation>`;
    }
    /**
     * Renders the focus ring component.
     */
    renderFocusRing() {
        return y `<md-focus-ring for="list"></md-focus-ring>`;
    }
    getSurfaceClasses() {
        return {
            open: this.open,
...
MdSubMenuItem.styles = [styles$J, styles$H, styles$K, styles$I];
...
MdOutlinedSegmentedButtonSet.styles = [styles$C, styles$D];
...
class SharedFab extends s$2 {
    constructor() {
        ...
        this.renderRipple = () => {
            return y `<md-ripple class="ripple"></md-ripple>`;
        };
    }
    render() {
        // Needed for closure conformance
    ...
    renderTouchTarget() {
        return this.reducedTouchTarget ? y `` :
            y `<div class="touch-target"></div>`;
    }
    renderLabel() {
        return this.label ? y `<span class="label">${this.label}</span>` : '';
    }
    renderIcon() {
        return y `<span class="icon">
        <slot name="icon"></slot>
      </span>`;
    }
}
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$A = i$4 `@media(forced-colors: active){.fab{--md-focus-ring-offset: 3px;border:1px solid ButtonText}.fab.extended{padding-inline-start:15px;padding-inline-end:19px}}/*# sourceMappingURL=forced-colors-styles.css.map */
`;
...
MdFab.styles = [styles$z, styles$B, styles$A];
MdFab = __decorate([
    e$a('md-fab')
], MdFab);
...
MdBrandedFab.styles = [styles$z, styles$y, styles$A];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$x = i$4 `:host{--_color: var(--md-divider-color, var(--md-sys-color-outline-variant, #cac4d0));--_thickness: var(--md-divider-thickness, 1px);box-sizing:border-box;color:var(--_color);display:flex;height:var(--_thickness);width:100%}:host([inset]),:host([inset-start]){padding-inline-start:16px}:host([inset]),:host([inset-end]){padding-inline-end:16px}:host::before{background:currentColor;content:"";height:100%;width:100%}@media(forced-colors: active){:host::before{background:CanvasText}}/*# sourceMappingURL=divider-styles.css.map */
`;
...
class Chip extends s$2 {
    ...
    render() {
        const primaryRipple = this.showPrimaryRipple ?
            y `<md-ripple ?disabled=${this.primaryRippleDisabled}></md-ripple>` :
            b;
        const primaryFocus = y `<md-focus-ring for=${this.primaryFocusFor}></md-focus-ring>`;
        return y `
      <div class="container ${o(this.getContainerClasses())}">
        ${!this.elevated ? y `<span class="outline"></span>` : b}
        ${this.elevated ? y `<md-elevation></md-elevation>` : b}
        ${primaryFocus}
        ${primaryRipple}
...
MdSuggestionChip.styles = [styles$v, styles$u];
...
MdFilterChip.styles = [styles$v, styles$t];
...
MdRadio.styles = [styles$r, styles$s];
MdRadio = __decorate([
    e$a('md-radio')
], MdRadio);
...
class Button extends s$2 {
    ...
    renderLabel() {
        return y `<span class="md3-button__label"><slot></slot></span>`;
    }
    renderLeadingIcon() {
...
MdTextButton.styles = [styles$p, styles$o];
...
MdOutlinedButton.styles = [styles$p, styles$n];
...
MdElevatedButton.styles = [styles$p, styles$l, styles$m];
...
MdTonalButton.styles = [styles$p, styles$l, styles$k];
...
MdFilledButton.styles = [styles$p, styles$l, styles$j];
...
class LinearProgress extends s$2 {
    ...
    render() {
      ...
      <div
          role="progressbar"
          class="linear-progress ${o(rootClasses)}"
          aria-label="${ariaLabel || b}"
          aria-valuemin="0"
          aria-valuemax="1"
          aria-valuenow="${this.indeterminate ? b : this.progress}">
        <div class="track"></div>
        <div class="buffer-bar" style=${i$1(bufferStyles)}></div>
        <div class="bar primary-bar" style=${i$1(progressStyles)}>
...
MdListItemLink.styles = [styles$J, styles$K];
...
MdListItem.styles = [styles$J, styles$K];
...
class Select extends s$2 {
    ...
    renderLabel() {
        ...
        return y `<div
        id="label"
        class="label">${this.displayText || y `&nbsp;`}</div>`;
    }
    renderSupportingText() {
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$c = i$4 `:host{color:unset;min-width:210px}.field{cursor:default;outline:none}.select{position:relative}.field,.select{min-width:inherit}:host{display:inline-flex}.label{width:100%}:host([disabled]){pointer-events:none}/*# sourceMappingURL=shared-styles.css.map */
`;
...
MdFilledSelect.styles = [styles$c, styles$d, styles$e];
...
MdSelectOption.styles = [styles$J, styles$H, styles$K, styles$I];
...
MdOutlinedSelect.styles = [styles$c, styles$a, styles$b];
...
class IconButton extends s$2 {
    constructor() {
        ...
        this.renderRipple = () => {
            return y `<md-ripple ?disabled="${!this.href && this.disabled}"></md-ripple>`;
        };
    }
    /**
    ...
    renderFocusRing() {
        return y `<md-focus-ring for=${this.href ? 'link' : 'button'}></md-focus-ring>`;
    }
    connectedCallback() {
        this.flipIcon = isRtl(this, this.flipIconInRtl);
        super.connectedCallback();
...
MdFilledTonalIconButton.styles = [styles$8, styles$9];
...
MdFilledIconButton.styles = [styles$8, styles$7];
...
MdStandardIconButton.styles = [styles$8, styles$6];
...
MdOutlinedIconButton.styles = [styles$8, styles$5];
