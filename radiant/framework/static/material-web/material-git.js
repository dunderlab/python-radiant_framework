...
MdOutlinedField.styles = [styles$W, styles$X];
...
MdOutlinedTextField.styles = [styles$T, styles$U, styles$V];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$Q = i$4 `.md3-autocomplete-surface{width:100%}/*# sourceMappingURL=autocomplete-surface-styles.css.map */
`;
...
MdAutocompleteSurface.styles = [styles$S, styles$Q];
MdAutocompleteSurface = __decorate([
    e$a('md-autocomplete-surface')
...
MdAutocompleteItem.styles = [styles$P];
MdAutocompleteItem = __decorate([
    e$a('md-autocomplete-item')
], MdAutocompleteItem);
...
MdFilledField.styles = [styles$W, styles$M];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$L = i$4 `:host{--_container-color: var(--md-list-container-color, var(--md-sys-color-surface, #fffbfe));color:unset}.md3-list{background-color:var(--_container-color);display:block;list-style-type:none;margin:0;min-width:300px;outline:none;padding:8px 0;position:relative}/*# sourceMappingURL=list-styles.css.map */
`;
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$K = i$4 `.md3-autocomplete-list{min-width:unset}/*# sourceMappingURL=autocomplete-list-styles.css.map */
`;
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$G = i$4 `.md3-autocomplete{display:inline-flex;flex:1}/*# sourceMappingURL=shared-styles.css.map */
`;
...
let MdFilledAutocomplete = class MdFilledAutocomplete extends Autocomplete {
    constructor() {
        super(...arguments);
        this.listTag = i$1 `md-autocomplete-list`;
        this.menuSurfaceTag = i$1 `md-autocomplete-surface`;
...
MdFilledAutocomplete.styles = [
    styles$T, styles$I, styles$J,
    styles$G, styles$H
];
MdFilledAutocomplete = __decorate([
    e$a('md-filled-autocomplete')
...
MdOutlinedAutocomplete.styles = [
    styles$T, styles$U, styles$V,
    styles$G, styles$F
];
MdOutlinedAutocomplete = __decorate([
    e$a('md-outlined-autocomplete')
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$t = i$4 `:host{--_color: var(--md-divider-color, var(--md-sys-color-outline-variant, #cac4d0));--_thickness: var(--md-divider-thickness, 1px);box-sizing:border-box;color:var(--_color);display:flex;height:var(--_thickness);width:100%}:host([inset]),:host([inset-start]){padding-inline-start:16px}:host([inset]),:host([inset-end]){padding-inline-end:16px}:host::before{background:currentColor;content:"";height:100%;width:100%}@media(forced-colors: active){:host::before{background:CanvasText}}/*# sourceMappingURL=divider-styles.css.map */
`;
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$s = i$4 `:host{--_color: var(--md-icon-color, inherit);--_font: var(--md-icon-font, "Material Icons");--_font-variation-settings: var(--md-icon-font-variation-settings, inherit);--_size: var(--md-icon-size, 24px);--_weight: var(--md-icon-weight, 400);display:inline-flex;color:var(--_color);font-family:var(--_font);font-weight:var(--_weight);font-style:normal;font-size:var(--_size);font-variation-settings:var(--_font-varation-settings);line-height:1;letter-spacing:normal;text-transform:none;white-space:nowrap;word-wrap:normal;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility;-moz-osx-font-smoothing:grayscale}span ::slotted(svg){fill:currentColor}span ::slotted(*){height:var(--_size);width:var(--_size)}/*# sourceMappingURL=icon-styles.css.map */
`;
...
MdOutlinedIconButtonToggle = __decorate([
    e$a('md-outlined-icon-button-toggle')
...
MdOutlinedLinkIconButton = __decorate([
    e$a('md-outlined-link-icon-button')
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$j = i$4 `:host{--_list-item-leading-avatar-color: var(--md-list-list-item-leading-avatar-color, var(--md-sys-color-primary-container, #eaddff));--_list-item-leading-avatar-shape: var(--md-list-list-item-leading-avatar-shape, 9999px);--_list-item-leading-avatar-size: var(--md-list-list-item-leading-avatar-size, 40px)}.md3-list-item__avatar{border-radius:var(--_list-item-leading-avatar-shape);display:inline-flex;height:var(--_list-item-leading-avatar-size);margin-inline-start:16px;width:var(--_list-item-leading-avatar-size)}/*# sourceMappingURL=list-item-avatar-styles.css.map */
`;
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$i = i$4 `:host{--_list-item-small-leading-video-height: var(--md-list-item-video-list-item-small-leading-video-height, 56px);--_list-item-large-leading-video-height: var(--md-list-item-video-list-item-large-leading-video-height, 69px);--_list-item-leading-video-width: var(--md-list-item-video-list-item-leading-video-width, 100px);--_list-item-leading-video-shape: var(--md-list-item-video-list-item-leading-video-shape, 0px);display:inline-flex}.md3-list-item__video{display:inline-flex;margin-block-end:12px;margin-block-start:12px;object-fit:cover;height:var(--_list-item-small-leading-video-height);width:var(--_list-item-leading-video-width);border-radius:var(--_list-item-leading-video-shape)}.md3-list-item__video.large{height:var(--_list-item-large-leading-video-height)}/*# sourceMappingURL=list-item-video-styles.css.map */
`;
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$h = i$4 `:host{--_list-item-leading-image-height: var(--md-list-item-image-list-item-leading-image-height, 56px);--_list-item-leading-image-width: var(--md-list-item-image-list-item-leading-image-width, 56px);--_list-item-leading-image-shape: var(--md-list-item-image-list-item-leading-image-shape, 0px)}.md3-list-item__image{display:inline-flex;margin-block-end:8px;margin-block-start:8px;margin-inline-start:16px;height:var(--_list-item-leading-image-height);width:var(--_list-item-leading-image-width);border-radius:var(--_list-item-leading-image-shape)}/*# sourceMappingURL=list-item-image-styles.css.map */
`;
...
MdListItemLink.styles = [styles$g, styles$P];
...
MdListItem.styles = [styles$g, styles$P];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$f = i$4 `:host{--_list-item-icon-color: var(--md-list-item-icon-list-item-icon-color, #000);--_list-item-icon-size: var(--md-list-item-icon-list-item-icon-size, 0);--_list-item-icon-opacity: var(--md-list-item-icon-list-item-icon-opacity, 1);display:inline-flex}.md3-list-item__icon{color:var(--_list-item-icon-color);opacity:var(--_list-item-icon-opacity);font-family:"Material Icons";font-weight:normal;font-style:normal;font-size:var(--_list-item-icon-size);line-height:1;letter-spacing:normal;text-transform:none;display:inline-flex;white-space:nowrap;word-wrap:normal;direction:ltr;height:100%;width:100%;padding-inline-start:16px;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility;-moz-osx-font-smoothing:grayscale;font-feature-settings:"liga"}/*# sourceMappingURL=list-item-icon-styles.css.map */
`;
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$d = i$4 `:host([active]) .list-item{background-color:var(--_list-item-selected-container-color)}.list-item:has(.submenu:hover){--md-ripple-hover-state-layer-opacity:0}/*# sourceMappingURL=menu-item-styles.css.map */
`;
...
MdMenuItemLink.styles = [styles$e, styles$P, styles$d];
...
MdMenuItem.styles = [styles$e, styles$P, styles$d];
...
MdSubMenuItem.styles = [styles$e, styles$P, styles$d];
...
MdFilledTextField.styles = [styles$T, styles$I, styles$J];
